...
SELECT COUNT(DISTINCT edad) AS usuarios_diferentes_java FROM usuarios_lenguajes WHERE lenguaje = 'Java';
...
SELECT * FROM usuarios_lenguajes WHERE edad > 25 AND lenguaje = 'TypeScript' LIMIT 1;

-- Ejercicio 16: Contar cuántos usuarios tienen un lenguaje asociado llamado 'Python'.
SELECT COUNT(*) AS usuarios_python FROM usuarios_lenguajes WHERE lenguaje = 'Python';

-- Ejercicio 17: Seleccionar los usuarios y sus lenguajes asociados, si tienen alguno, ordenados por nombre de usuario.
SELECT nombre, apellido, IFNULL(lenguaje, 'Ninguno') AS lenguaje FROM usuarios_lenguajes ORDER BY nombre;
...
SELECT nombre, apellido, IFNULL(lenguaje, 'Ninguno') AS lenguaje, LENGTH(lenguaje) AS cantidad_lenguajes FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;
...
SELECT nombre, apellido, edad FROM usuarios_lenguajes GROUP BY edad HAVING COUNT(*) > 1;
...
SELECT nombre, apellido, IFNULL(lenguaje, 'Ninguno') AS lenguaje FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL ORDER BY lenguaje;

-- Ejercicio 32: Contar cuántos usuarios tienen una edad entre 20 y 25 años y saben al menos un lenguaje. 
SELECT COUNT(*) AS usuarios_edad_20_25_con_lenguaje FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25 AND lenguaje IS NOT NULL;
...
SELECT COUNT(*) AS usuarios_con_lenguaje_script FROM usuarios_lenguajes WHERE lenguaje LIKE '%Script%';
...
SELECT COUNT(*) AS usuarios_lenguaje_P_menos_28 FROM usuarios_lenguajes WHERE lenguaje LIKE 'P%' AND edad < 28;
